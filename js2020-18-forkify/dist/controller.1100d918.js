...
})({"0596176b490f0f6391a9aa8c784a873d":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "1100d918403d4984bd9a4591888262d4";
...
},{}],"771f7f785034e31e79c17d137a7e335b":[function(require,module,exports) {
require('./bundle-manifest').register(JSON.parse("{\"bd9a4591888262d4\":\"controller.1100d918.js\",\"b83bd49c823c2166\":\"icons.229c6d47.svg\"}"));
...
exports.controlSearchResults = void 0;
...
const controlRecipes = async function () {
  try {
    ...
    _recipeView.default.renderSpinner(); // Update to marked result


    _resultsView.default.update(model.getSearchResultsPage()); // 0. update bookmark


    _bookmarksView.default.update(model.state.bookmarks); // 1. Loading recipe


    await model.loadRecipe(id); // 2. Display recipe
...
const renderResAndBtn = function (page) {
  // 3. Render results
  _resultsView.default.render(model.getSearchResultsPage(page)); // 4. Render pagination
...
const controlSearchResults = async function () {
  try {
    ...
    _resultsView.default.renderSpinner(); // 2. Load results
...
exports.controlSearchResults = controlSearchResults;
...
const controlServings = function (newServing) {
  // 1. Update serving
  model.updateServings(newServing); // 2. Render recipe
...
const controlAddBookmark = function () {
  // 1. Add bookmark
  if (!model.state.recipe.bookmarked) model.addBookmark(model.state.recipe);else model.deleteBookmark(model.state.recipe.id); // 2. Update view

  _recipeView.default.update(model.state.recipe); // 3. Add bookmark to list
...
const controlAddRecipe = async function (newRecipe) {
  try {
    ...
    console.log(model.state.recipe); // Render added recipe

    _recipeView.default.render(model.state.recipe); // Success message


    _addRecipeView.default.renderMessage(); // Render bookmarks


    _bookmarksView.default.render(model.state.bookmarks); // Change url id


    window.history.pushState(null, '', `#${model.state.recipe.id}`); // Clode modal
    ...
    _addRecipeView.default.renderError(err.message); // quên bỏ err.message => undefined
...
const createRecipeObject = function (data) {
  ...
  return {
    ...
    ...(recipe.key && {
      key: recipe.key
    }) // nếu ko có key (left) => falsey value => right ko thực hiện. Nếu left có key => return giá trị key bên phải
...
const addBookmark = function (recipe) {
  // Thêm bookmarks
  state.bookmarks.push(recipe); // Đánh dấu bookmarked
...
const deleteBookmark = function (id) {
  ...
  state.bookmarks.splice(index, 1); // Đánh dấu đã xóa
...
const uploadRecipe = async function (newRecipe) {
  try {
    const ingredients = Object.entries(newRecipe).filter(entry => entry[0].startsWith('ingredient') && entry[1] !== '').map(ing => {
      ...
      if (ingArr.length !== 3) throw new Error('Wrong ingredients format. Please submit correct format. 👨‍🍳 Hint: 1,kg,sugar');
...
exports.KEY = exports.MODAL_CLOSE_SEC = exports.DEF_FIRST_PAGE = exports.RES_PER_PAGE = exports.TIMEOUT_SEC = exports.API_URL = void 0;
...
const DEF_FIRST_PAGE = 1;
exports.DEF_FIRST_PAGE = DEF_FIRST_PAGE;
const MODAL_CLOSE_SEC = 1.5;
exports.MODAL_CLOSE_SEC = MODAL_CLOSE_SEC;
const KEY = 'a4e928f1-8ccb-4d7b-8262-cfe8ae2aed98'; // find your key on: https://forkify-api.herokuapp.com/v2
...
class RecipeView extends _View.default {
  constructor(...args) {
    ...
    _defineProperty(this, "_errorMessage", 'Could not find any recipe. Please try again!');
...
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","url:../../img/icons.svg":"ed0140d0b502e8a570fd0beecfeb0636"}],"61b7a1b097e16436be3d54c2f1828c73":[function(require,module,exports) {
"use strict";
...
class View {
  ...
  update(data) {
    ...
    newElements.forEach((newEl, i) => {
      const curEl = curElements[i]; // change text element
      // newEl.firstChild.nodeValue.trim() check để replace thẻ CHỨA TEXT chứ ko phải thay hết cả node

      if (!newEl.isEqualNode(curEl) && newEl.firstChild?.nodeValue.trim() !== '' // Optional chaining (make sure 100% work)
      ) {
...
},{"url:../../img/icons.svg":"ed0140d0b502e8a570fd0beecfeb0636"}],"ed0140d0b502e8a570fd0beecfeb0636":[function(require,module,exports) {
module.exports = require('./bundle-url').getBundleURL() + require('./relative-path')("bd9a4591888262d4", "b83bd49c823c2166");
...
class searchView extends _View.default {
  ...
  addHandlerSearch(handler) {
    this._parentElement.addEventListener('submit', function (e) {
      e.preventDefault();
      model.state.search.page = _config.DEF_FIRST_PAGE; // reset về trang đầu => Có thể search ra những data ít page hơn lần search trước
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","../config.js":"09212d541c5c40ff2bd93475a904f8de","../model.js":"aabf248f40f7693ef84a0cb99f385d1f"}],"eacdbc0d50ee3d2819f3ee59366c2773":[function(require,module,exports) {
"use strict";
...
class ResultsView extends _View.default {
  constructor(...args) {
    ...
    _defineProperty(this, "_errorMessage", 'No recipe found. Please try again!');
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","./previewView.js":"e4d6583325a8b6c9380670c4f233bf07","url:../../img/icons.svg":"ed0140d0b502e8a570fd0beecfeb0636"}],"e4d6583325a8b6c9380670c4f233bf07":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","url:../../img/icons.svg":"ed0140d0b502e8a570fd0beecfeb0636"}],"d2063f3e7de2e4cdacfcb5eb6479db05":[function(require,module,exports) {
"use strict";
...
class PaginationView extends _View.default {
  ...
  _generateMarkup() {
    ...
    const numPages = Math.ceil(this._data.results.length / this._data.resultsPerPage); // Page 1 và CÓ page khác
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","url:../../img/icons.svg":"ed0140d0b502e8a570fd0beecfeb0636"}],"7ed9311e216aa789713f70ebeec3ed40":[function(require,module,exports) {
"use strict";
...
class BookmarksView extends _View.default {
  constructor(...args) {
    ...
    _defineProperty(this, "_errorMessage", 'No bookmark found. Please try again! 🙆‍');
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","./previewView.js":"e4d6583325a8b6c9380670c4f233bf07","url:../../img/icons.svg":"ed0140d0b502e8a570fd0beecfeb0636"}],"4dd83c2a08c1751220d223c54dc70016":[function(require,module,exports) {
"use strict";
...
class AddRecipeView extends _View.default {
  constructor() {
    ...
    _defineProperty(this, "_message", 'Your recipe was added');
...
exports.default = _default;
},{"./View.js":"61b7a1b097e16436be3d54c2f1828c73","url:../../img/icons.svg":"ed0140d0b502e8a570fd0beecfeb0636"}],"e155e0d3930b156f86c48e8d05522b16":[function(require,module,exports) {
/**
...
},{}]},{},["0596176b490f0f6391a9aa8c784a873d","771f7f785034e31e79c17d137a7e335b","175e469a7ea7db1c8c0744d04372621f"], null)

//# sourceMappingURL=controller.1100d918.js.map
